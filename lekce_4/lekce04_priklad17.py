...
class Uzivatel:
    ...
    def pripocti_zhlednuti(self,zhlednutaPolozka):
        self.delka_sledovani += zhlednutaPolozka.get_celkova_delka()

    def vrat_pocet_zhlednuti(self):
        return f"Celkový čas zhlednutí filmů a seriálů je {self.delka_sledovani} minut."

uzivatel1 = Uzivatel("Marek Nový")


uzivatel1.pripocti_zhlednuti(Film1)
uzivatel1.pripocti_zhlednuti(Serial1)
print(uzivatel1.vrat_pocet_zhlednuti())
